...
frequency_table = word_frequency(split_chapter)

print("{0: <20}{1} \n{2}".format("word", "Count", "="*25))
...
print("\n{0} is the longest word".format(longest_word))